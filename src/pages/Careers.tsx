...
const Careers = () => {
  return (
    <>
      <SEO 
        title="Careers" 
        description="Join the innovative team at R.S.infotech. Explore our current job openings and company culture."
      />
      
      <PageHeader 
        title="Join Our Team" 
        subtitle="Explore Career Opportunities at R.S.infotech"
